...
public class StarField : MonoBehaviour
{
    ...
    (new int[] { 15, 337, 603, 165, 464, 8762, 8961, 269, 215, 458, 8976, 335, 8965, 154, 3546, 5516, 68, 226, 271, 163},
     new int[] { 15, 165, 165, 337, 337, 603, 337, 269, 269, 226, 226, 335, 337, 154,
                 154, 68, 68, 8965, 8965, 8976, 8976, 8961, 8965, 8762, 154, 165, 165,
                 163, 163, 215, 215, 271}),
    // Antlia
    ...
    // Aquarius TO BE FINISHED
    (new int[] { 7950, 7990, 8232, 8418, 8414, 8539, 8559, 8515, 8499, 8512, 8698},
     new int[] { 7950, 7990, 7990, 8232, 8232, 8418, 8232, 8414, 8414, 8539, 8539, 8559,
                 8559, 8518, 8518, 8414, 8414, 8499, 8499, 8512, 8512, 8698,}),
    // Aquila
    (new int[] { },
     new int[] { }),
    // Template
